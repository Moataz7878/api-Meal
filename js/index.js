...
async function apiChiledHome() {
  let keymealID =localStorage.getItem('dataHomesStrMeal')
  $(".loading-container").fadeIn(100)
  let meal = await fetch(`https://www.themealdb.com/api/json/v1/1/lookup.php?i=${keymealID}`)
  let dataChiledHome = await meal.json()
    ...
    if (meals) {
      ...
      for (let i = 0; i < meals.length; i++) {
       const element = meals[i];
         ...
         cartona +=` <div class="col-xl-3  col-lg-4 col-md-6">
         <a onclick="getMeal('${element.idMeal}')"  id="imageHome" class="text-black"><div class="item w-100 position-relative overflow-hidden">
